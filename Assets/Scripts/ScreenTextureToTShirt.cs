...
public class ScreenTextureToTShirt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //false->mipmap: 在屏幕中顯示大小不同時給予不同級別的texture，這裡不需要
    }
    ...
    public void ScreenShot_Button()
    {
        ...
        t_shirt_body.GetComponent<Renderer>().material.SetVector("_Uvpoint1", new Vector4(TopLeft_Pl_W.x, TopLeft_Pl_W.y, TopLeft_Pl_W.z, 1.0f)); //1f表示浮點數
        ...
        t_shirt_right.GetComponent<Renderer>().material.SetVector("_Uvpoint1", new Vector4(TopLeft_Pl_W.x, TopLeft_Pl_W.y, TopLeft_Pl_W.z, 1.0f)); //1f表示浮點數
        ...
        t_shirt_left.GetComponent<Renderer>().material.SetVector("_Uvpoint1", new Vector4(TopLeft_Pl_W.x, TopLeft_Pl_W.y, TopLeft_Pl_W.z, 1.0f)); //1f表示浮點數
        ...
        t_shirt_body.GetComponent<Renderer>().material.SetMatrix("_VP", VP); //將截圖時的矩陣轉換信息傳遞給shader
        t_shirt_right.GetComponent<Renderer>().material.SetMatrix("_VP", VP); //將截圖時的矩陣轉換信息傳遞給shader     
        t_shirt_left.GetComponent<Renderer>().material.SetMatrix("_VP", VP); //將截圖時的矩陣轉換信息傳遞給shader     

        t_shirt_body.GetComponent<Renderer>().material.mainTexture = TextureShot; //將texture2d複製給模型
        t_shirt_right.GetComponent<Renderer>().material.mainTexture = TextureShot; //將texture2d複製給模型
        t_shirt_left.GetComponent<Renderer>().material.mainTexture = TextureShot; //將texture2d複製給模型
